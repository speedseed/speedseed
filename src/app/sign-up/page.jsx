        ...
        <div className='md:shadow py-10 px-5 md:rounded-xl block w-full   md:w-[60%] lg:w-[40%] xl:w-[30%] mx-auto bg-white'>
            <div className='text-center mb-8'>
                ...
                <div className='mt-8'>
                    ...
                    <p className='text-sm'>Sign Up to continue to SpeedSeed.</p>
                    <p></p>
                </div>
            </div>
            <div className='mb-5'>
                ...
                <div className='mb-6 text-center'>
                    ...
                    <button className='text-green-700 md:text-sm text-xs'>Already have an account <Link href={'/sign-in'} className='underline cursor-pointer'>Sign In</Link>?</button>
                </div>
                <div className='mt-5'>
                    <button className='w-full py-3 bg-green-700 rounded-lg text-white '>Sign Up</button>
                </div>
            </div>
